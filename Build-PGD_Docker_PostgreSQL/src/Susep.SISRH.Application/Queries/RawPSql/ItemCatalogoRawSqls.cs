            ...
            get
            {
                return @"
					SELECT  i.""itemCatalogoId"" 
                            ...
                            ,i.""entregasEsperadas""    
                            ,(SELECT CAST(COUNT(1) AS SMALLINT) FROM ""ProgramaGestao"".""PactoTrabalhoAtividade"" WHERE ""itemCatalogoId"" = i.""itemCatalogoId"") ""temPactoCadastrado""
                            ,(SELECT CAST(COUNT(1) AS SMALLINT) FROM ""ProgramaGestao"".""CatalogoItemCatalogo"" WHERE ""itemCatalogoId"" = i.""itemCatalogoId"") ""temUnidadeAssociada""
