            ...
            get
            {
                return @"
					SELECT  p.""pactoTrabalhoAtividadeId""
                            ,p.""pactoTrabalhoId""
                            ,p.""itemCatalogoId""
                            ,i.""titulo"" || ""ProgramaGestao"".""IIF""(i.""complexidade"" IS NULL OR i.""complexidade"" = '', ''::text, ' - ' || i.""complexidade"") AS ""itemCatalogo""
                            ...
                            ,CASE WHEN p.""modalidadeExecucaoId"" IS NULL THEN 
                                ""ProgramaGestao"".""IIF""(""pt"".""formaExecucaoId"" = 101, 0, 1)
                             ELSE ""ProgramaGestao"".""IIF""(p.""modalidadeExecucaoId"" = 101, 0, 1) END ""execucaoRemota""
            ...
            get
            {
                return @"
					SELECT  p.""pactoTrabalhoSolicitacaoId""                          
                            ...
                            ,COALESCE(""pe"".""pesNome"", ""solicitante"") ""solicitante""
                            ,""dadosSolicitacao""
