            ...
            get
            {
                return @"
                    SELECT  i.""itemCatalogoId"" 
							,i.""titulo""         
                            ,i.""titulo"" || ""ProgramaGestao"".""IIF""(i.""complexidade"" IS NULL OR i.""complexidade"" = '', ''::text, ' - ' || i.""complexidade"") || '  (""pres"".:' || cast(i.""tempoPresencial"" AS varchar(5)) || 'h / ""rem"".:' || cast(i.""tempoRemoto"" AS varchar(5)) || 'h)' AS ""tituloCompleto""
                            ,i.""complexidade"" 
